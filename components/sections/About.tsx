      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-9 space-y-12">
            <h2 className={`text-2xl md:text-3xl leading-relaxed font-light text-gray-800 transition-all duration-600 ${isVisible ? 'animate-fade-in-up delay-100' : 'opacity-0 translate-y-5'}`}>
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 gap-12 pt-8 border-t border-gray-100 transition-all duration-600 ${isVisible ? 'animate-fade-in-up delay-200' : 'opacity-0 translate-y-5'}`}>
              {/* Experience List */}
              <div>
                ...
                <ul className="space-y-4 text-sm text-gray-700">
                  <li className="flex justify-between items-baseline group cursor-default smooth-color">
